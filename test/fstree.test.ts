...
describe('fstree', () => {
    it('write creates a simple file tree', () => {
    ...
    it('read loads a file tree correctly', () => {
    ...
    it('write handles empty directories', () => {
    ...
    it('read handles empty directories', () => {
        volume.fromNestedJSON({
            'test-empty-read': {
                empty: {},
            },
    ...
    it('write handles deeply nested structures', () => {
        const tempDir = p.resolve('test-deep');
        const tree: t.FSTree = new Map([
            [
                'level1',
                new Map([
                    ['level2', new Map([['level3', new Map([['deep.txt', 'deep content']])]])],
                ]),
            ],
        ]);
